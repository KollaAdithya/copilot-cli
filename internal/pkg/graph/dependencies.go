...
func NewGraph1(containers map[string]ContainerDependency, initialStatus ContainerStatus) (*Graph1, error) {
	...
	log.Infoln("containers are", containers)
...
// func filterChildrenByCondition(g *Graph1, k string, c dependsOn) []*Vertex {
// 	// Implement filtering based on the specified condition (e.g., Start, Healthy)
// 	// You'll need to consider essential and non-essential containers here.
// }

// func filterParentsByCondition(g *Graph1, k string, c dependsOn) []*Vertex {
// 	// Implement filtering based on the specified condition (e.g., Start, Healthy)
// 	// You'll need to consider essential and non-essential containers here.
// }
